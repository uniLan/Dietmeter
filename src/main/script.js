...
function questionHandler() {
	...
	if (userinput == What should I eat today to lose weight?){
		botaddmessage = "Breakfast
...
Prepare in Advance: Meal prepping can help you stick to your meal plan and avoid reaching for convenient, less healthy options."}
	if (userinput == "What exercises should I do today?" {
		botaddmessage = " Here's a simple and effective routine that you can do at home or at a gym, requiring minimal equipment:
...
Remember, the goal is to build a habit of regular physical activity, so find exercises that you enjoy and that fit into your lifestyle."}
	if (userinput == "I am 200 pounds and 6 feet tall, how many calories should I eat in a day to lose weight?"){
		botaddmessage = "To lose weight, you need to eat fewer calories than your TDEE. A deficit of 500-1000 calories/day is a common goal that leads to a safe, sustainable weight loss of about 1-2 pounds per week.
...
Remember, gaining weight should be a gradual process. Focus on consistent, healthy eating habits and consult with a healthcare provider or a registered dietitian for personalized advice and to ensure your meal plan meets all your nutritional needs."}
	if (userinput == "How can I eat healthily on a budget?"){
		botaddmessage = "-Meal Planning: Plan your meals for the week to avoid buying unnecessary items and stick to a shopping list based on those plans.
